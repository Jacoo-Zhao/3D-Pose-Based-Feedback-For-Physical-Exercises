...
from models import GCN_corr_class_v4_22Spring, GCN_class, GCN_corr_ori
from utils import lr_decay, train_class, test_class, train_corr, test_corr, train_corr_class_v4, test_class_v4, test_corr_v4
...
if __name__ == "__main__":
    # version_name = input('How do you want to name this attempt in result.csv? e.g. epoch-160'+'\n')
    option = Options().parse()
    # print('option.combined:', option.combined)
