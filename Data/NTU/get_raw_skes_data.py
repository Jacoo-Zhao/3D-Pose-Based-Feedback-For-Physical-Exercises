...
if __name__ == '__main__':
    save_path = '/cvlabdata2/home/ziyi/3D-Motion-Correction/Work_on_related_works/data/ntu'

    skes_path = '/cvlabdata2/home/ziyi/3D-Motion-Correction/Work_on_related_works/data/ntu/nturgb+d_skeletons'
    stat_path = osp.join(save_path, 'statistics')
    if not osp.exists('/cvlabdata2/home/ziyi/3D-Motion-Correction/Work_on_related_works/data/ntu/raw_data'):
        os.makedirs('/cvlabdata2/home/ziyi/3D-Motion-Correction/Work_on_related_works/data/ntu/raw_data')
